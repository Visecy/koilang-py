...
class Writer:
    ...
    def __init__(self, py_file: IO[str], config: Optional[WriterConfig] = None) -> None:
    ...
    def write_command_with_options(self, command: Command, options: Optional[FormatterOptions] = None, param_options: Optional[dict[ParamFormatSelector, FormatterOptions]] = None) -> None:
